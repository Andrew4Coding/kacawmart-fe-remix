...
const featuredProducts = [
    ...
    },
    {
        ...
        rating: 4.7,
        reviews: 156,
        image: "https://images.unsplash.com/photo-1558089687-f282ffcbc0d4?w=500&q=80",
        category: "electronics",
        discount: 10,
        badge: "New",
    },
    ...
    },
    {
        ...
        rating: 4.5,
        reviews: 142,
        image: "https://images.unsplash.com/photo-1618577608401-46f4a95e0e4d?w=500&q=80",
        category: "electronics",
        discount: 0,
        badge: "",
    },
    ...
    if (discount > 0) {
        ...
        return (
            <div className="flex items-center gap-2">
                <span className="text-lg font-bold text-emerald-600">${discountedPrice.toFixed(2)}</span>
        ...
        <main className="w-full font-sans">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div className={`space-y-6 ${isVisible ? "animate-fadeIn" : "opacity-0"}`}>
                            ...
                            <p className="text-lg md:text-xl text-gray-600 max-w-lg">
                                Your one-stop marketplace for quality products at unbeatable prices. Join thousands of satisfied
                                customers today.
                            </p>
                            ...
                            <div className="flex items-center gap-6 pt-4">
                                ...
                                <p className="text-sm text-gray-600">
                                    <span className="font-bold text-emerald-600">10,000+</span> happy customers
                                </p>
                            </div>
                        </div>
            ...
            <section className="py-16 bg-white">
                <div className="container mx-auto px-4 md:px-6">
                    <div className="text-center mb-12">
                        ...
                        <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4 font-serif">Browse by Category</h2>
                ...
                <div className="container mx-auto px-4 md:px-6">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <h2 className="text-3xl md:text-4xl font-bold mb-4 font-serif">Get 20% Off Your First Purchase</h2>
                            <p className="text-lg opacity-90 mb-8 max-w-lg">
                                Sign up for our newsletter and receive a special discount code for your first order. Don't miss out on
                            ...
                            <div className="flex flex-col sm:flex-row gap-4">
                                ...
                                <Button className="bg-white text-emerald-700 hover:bg-gray-100 px-6 py-3 rounded-lg">Subscribe</Button>
                            </div>
                            <p className="text-sm opacity-70 mt-4">By subscribing, you agree to receive marketing emails from us.</p>
                        </div>
                        ...
                        <div className="flex justify-center mt-8 gap-2">
                            {testimonials.map((_, i) => (
                                <button
                                    ...
                                    className={`w-3 h-3 rounded-full transition-all duration-300 ${i === currentTestimonial ? "bg-emerald-600 w-6" : "bg-gray-300"
                                        }`}
            ...
            <section className="py-16 bg-gray-50">
                <div className="container mx-auto px-4 md:px-6">
                    <div className="text-center mb-12">
                        ...
                        <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4 font-serif">The KACAWMart Advantage</h2>
                        <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        ...
                        <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow">
                            ...
                            <p className="text-gray-600">Your transactions are protected with industry-leading security protocols.</p>
                        </div>
            ...
            <section className="py-16 bg-emerald-600 text-white">
                <div className="container mx-auto px-4 md:px-6 text-center">
                    <h2 className="text-3xl md:text-4xl font-bold mb-6 font-serif">Ready to Start Shopping?</h2>
                    <p className="text-lg opacity-90 mb-8 max-w-2xl mx-auto">
                        Join thousands of satisfied customers and discover the best deals on KACAWMart today.
                    </p>
    ...
    return (
        ...
        >
            ...
            <CardContent className="p-4">
                ...
                <div className="mt-2">{formatPrice(product.price, product.discount)}</div>
            </CardContent>
