...
import { AlertCircle, CalendarIcon, CheckCircle2, CreditCard, Lock, Mail, MapPin, Phone, User } from "lucide-react"
...
const customerRegisterSchema = z.object({
    ...
    birthdate: z.date(),
    phone: z.string().regex(/^\+\d{10,14}$/, "Phone number must be in international format"),
...
export function RegisterForm() {
    ...
    async function onSubmit(data: CustomerRegisterFormValues | SellerRegisterFormValues) {
        ...
        try {
            ...
            const profileImageUrl = await uploadFile(data.profileAttachment as File, `${data.username}`)
        ...
        <div className="w-full max-w-4xl mx-auto">
            <Card className="w-full border-none shadow-xl">
                <CardHeader className="space-y-1 text-center">
                    ...
                    <CardDescription>Fill in your details to get started with our platform</CardDescription>
                </CardHeader>
                <CardContent>
                    {error && (
                    ...
                    <Tabs value={currentTab} onValueChange={setCurrentTab} className="w-full">
                        <TabsList className="grid w-full grid-cols-2 mb-8">
                            <TabsTrigger value="customer" className="data-[state=active]:bg-slate-900 data-[state=active]:text-white">
                                Customer Account
                            </TabsTrigger>
                            <TabsTrigger value="seller" className="data-[state=active]:bg-slate-900 data-[state=active]:text-white">
                                Seller Account
                            </TabsTrigger>
                        </TabsList>
                        ...
                        <TabsContent value="customer" className="space-y-4 mt-4">
                            <div className="bg-slate-50 p-4 rounded-lg mb-6 flex items-start gap-3">
                                ...
                                <div>
                                    <h3 className="font-medium text-slate-900">Customer Registration</h3>
                                    <p className="text-sm text-slate-600">Create a customer account to browse and purchase products</p>
                                </div>
                            </div>
                                            ...
                                            <FormField
                                                ...
                                                render={({ field: { value, onChange, ...fieldProps } }) => (
                                                    ...
                                                    >
                                                        ...
                                                        <FormControl>
                                                            <FileInput
                                                                file={customerForm.getValues(`profileAttachment`) as File | null}
                        ...
                        <TabsContent value="seller" className="space-y-4 mt-4">
                            <div className="bg-slate-50 p-4 rounded-lg mb-6 flex items-start gap-3">
                                <CheckCircle2 className="h-5 w-5 text-slate-600 mt-0.5" />
                                <div>
                                    <h3 className="font-medium text-slate-900">Seller Registration</h3>
                                    <p className="text-sm text-slate-600">Create a seller account to list and sell your products</p>
                                </div>
                            </div>
                                            ...
                                            <FormField
                                                ...
                                                render={({ field: { value, onChange, ...fieldProps } }) => (
                                                    ...
                                                    >
                                                        ...
                                                        <FormControl>
                                                            <FileInput
                                                                file={sellerForm.getValues(`profileAttachment`) as File | null}
                                                                onFileChange={(file: File) => {
