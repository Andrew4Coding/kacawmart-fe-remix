        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="space-y-6">
            ...
            <p className="text-lg md:text-xl text-gray-600 max-w-lg">
              Temukan berbagai produk terbaik di KACAWMart! Belanja berbagai
              macam kebutuhan dengan harga terbaik, kualitas terjamin, dan
              pengalaman belanja yang menyenangkan. Segera jelajahi berbagai
              kategori dan temukan produk favoritmu!
            </p>
          </div>
        </div>
      </section>
